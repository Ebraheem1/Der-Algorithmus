...
let applicationController = {
        ...
        if (!errors) {
            ...
            Application.findOne({
                ...
                if(application){
                    ...
                    user.username = application.username.toLowerCase();
                    user.password = pass;
                    user.phoneNumber = application.phoneNumber;
                    user.email = application.email.toLowerCase();
   ...
   checkUsername: function(req, res){
        ...
        if(req.body.username && req.body.username != ''){
            ...
            Application.find({username: req.body.username.toLowerCase()}, function(err, applications){
    ...
    checkEmail: function(req, res){
        ...
        if(req.body.email && req.body.email != ''){
            ...
            Application.find({email: req.body.email.toLowerCase()}, function(err, applications){
