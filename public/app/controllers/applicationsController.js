...
var app = angular.module('applicationsController', ['applicationServices', 'pagingServices']);

app.controller('applicationsCtrl', function(Application, Pager, $scope, $routeParams){
	...
	Application.getAllApplications().then(function(applications){
		...
		if(applications.data.authenticated){
			...
			if(applications.data.success){
				...
				console.log('a7a');
				app.errMsg = applications.data.message;
